...
| Metric | Budget |
|---|---|
| Cold start to first paint | < 120 ms |
...
**M0 — Skeleton (½ day).** Repo laid out like omacut, `omafile.pro`, `bin/build`, a themed empty window that opens in under 120 ms. Prove the startup budget before writing anything else; it's much harder to recover later.
